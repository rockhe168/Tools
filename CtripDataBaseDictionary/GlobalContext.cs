...
namespace CtripDataBaseDictionary
{
    ...
    public class GlobalContext
    {
        ...
        /// <summary>
        /// {0}=服务器，{1}=windows登录，还是sqlserver 登录，{2}=数据库
        /// </summary>
        public static string SqlConnectionStringTemplate="server={0};{1};{2}";
        ...
        private static List<DataBaseContext> dataBaseContexts = null; 
        /// <summary>
        /// 当前服务器所有数据库列表
        /// </summary>
        public static List<DataBaseContext> DataBaseContexts
        {
            get
            {
                ...
                {
                    dataBaseContexts = DAOHelper.GetAllDataBase();
                }
                return dataBaseContexts;
            }
        }
        ...
        /// 数据库名称
        /// </summary>
        public const string DatabaseTag = "{DataBaseName}";
        ...
        /// Domain实体类模板地址
        /// </summary>
        public const string DomainEntityTemplateUrl = "Template\\PO\\Entity.cs";
